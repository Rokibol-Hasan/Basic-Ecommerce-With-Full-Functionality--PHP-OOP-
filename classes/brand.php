...
class Brand
{
    ...
    public function brandInsert($brandName)
    {
        ...
        if (empty($brandName)) {
            ...
            if ($brandInsert) {
                $msg = "<h6 class='success'>Brand Name Inserted Successfully</h6>";
                return $msg;
            } else {
                $msg = "<h6 class='error'>Brand Not Inserted!!</h6>";
                return $msg;
            }
        }
    }
    ...
    public function brandUpdate($brandId, $brandName)
    {
        ...
        if (empty($brandName)) {
            ...
            if ($brandUpdate) {
                $msg = "<h6 class='success'>Brand Updated Successfully</h6>";
                return $msg;
            } else {
                $msg = "<h6 class='error'>Brand Not Updated!!</h6>";
                return $msg;
            }
        }
    }
