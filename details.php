				...
				while ($details = $getDetails->fetch_assoc()) { ?>
					<div class="cont-desc span_1_of_2">
						...
						<div class="desc span_3_of_2">
							...
							<div class="product-compare mt-2">
								<form action="" method="post">
									<?php
									if (isset($_POST['compare'])) {
										$customerId = Session::get("customerId");
										$cmprid = $_POST['cmprid'];
										$insertCompare = $pd->insertCompare($customerId, $cmprid);
									}
									...
									?>
									<input type="hidden" class="buyfield" name="cmprid" value="<?php echo $details['productId']?>" />
									<input type="submit" class="buyfield" name="compare" value="Compare" />
								</form>
